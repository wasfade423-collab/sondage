...
<<<<<<< HEAD
                ...
                <!--  Le formulaire 5 -->
                <div>
                    <<<<<<< HEAD=======<h2>RetireAfrika(validation du concept)</h2>
...
=======
>>>>>>> af5fce529cbc68c54935a2c7470ce9cfd3b8ef51
        </div>
        <!--  Le formulaire 3 -->
        <div>
        </div>
...
>>>>>>> 1c0712fb20b4f50d2fc85908132719e57bd181d8
                ...
                <div>
                    <h2>Freins et suggestions</h2>
                    <!-- Empecher-->
                    <label>Qu'es ce qui pourrait vous empecher d'utiliser RetireAfrka ?</label>
                    <input type="radio" name="empecher" class="empecher" value="manque_de_confiance"><label>Manque de confiance</label>
                    <input type="radio" name="empecher" class="empecher" value="revenus_insuffisants"><label>Revenus Insuffisants</label>
                    <input type="radio" name="empecher" class="empecher" value="manque_de_connaissances"><label>Manque de connaissances</label>
                    <input type="radio" name="empecher" class="empecher" value="difficultés_téléphone"><label>Difficultés avec le téléphone</label>
                    <input type="radio" name="empecher" class="empecher" value="autre"><label>Autre</label>
                    <!-- Suggestion-->
                    <label for="PayVil">Avez-vous une suggestion pour améliorer cette solution ?</label>
                    <input type="text" name="suggestion" id="suggestion" placeholder="Suggestion">
                </div>
